...
def _matris_model_args_common(model_name: str) -> Argument:
    ...
    doc_use_precomputed_graphs = "Whether to use precomputed graphs"
    ...
    return Argument(
        ...
        [
            ...
            Argument("use_precomputed_graphs", bool, optional=True, default=False, doc=doc_use_precomputed_graphs),
        ],
